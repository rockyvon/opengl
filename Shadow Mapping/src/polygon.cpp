...
void Cube::draw(ShaderManager * shader, mat4 model)
{
	...
	shader->setUniform1i("material.difTex", 1);
	glActiveTexture(GL_TEXTURE2);
	glBindTexture(GL_TEXTURE_2D, texture_spe);
	shader->setUniform1i("material.speTex", 2);
	shader->setUniform1i("material.shininess", 8);
	shader->setUniform1i("material.hasTexture", 1);
	shader->setUniform1i("material.hasColor", 0);
	shader->setUniform1i("hasNormal", 1);
